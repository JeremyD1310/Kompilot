...
const pages = [
  ...
  ['/signup', 'Créer un compte Kompilot — Essai gratuit 14 jours', 'Créez votre espace Kompilot et démarrez un essai gratuit de 14 jours, sans carte bancaire.', 'Créez votre espace Kompilot', 'Démarrez un essai de 14 jours avec 1 utilisateur, 1 établissement, 150 crédits IA et 10 SMS. Les actions sensibles restent soumises à validation humaine.'],
