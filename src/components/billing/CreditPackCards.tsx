...
interface PackOption {
  id: 'ai_topup_250' | 'ai_topup_750' | 'ai_topup_2000';
  name: string;
  credits: number;
  price: number;
  priceLabel: string;
...
const PACKS: PackOption[] = [
  { id: 'ai_topup_250', name: 'Starter', credits: 250, price: 19, priceLabel: '19 €', perCredit: '0,08 € / crédit' },
  { id: 'ai_topup_750', name: 'Boost', credits: 750, price: 49, priceLabel: '49 €', perCredit: '0,07 € / crédit', highlighted: true, badgeLabel: 'Meilleure valeur' },
  { id: 'ai_topup_2000', name: 'Power', credits: 2000, price: 99, priceLabel: '99 €', perCredit: '0,05 € / crédit' },
];
