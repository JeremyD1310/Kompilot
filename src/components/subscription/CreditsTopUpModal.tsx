...
const PACKS: CreditPack[] = [
  { id: 'ai_topup_250', name: 'Pack 250', credits: 250, priceEur: 19, pricePerCredit: '0,08€', highlight: false },
  { id: 'ai_topup_750', name: 'Pack 750', credits: 750, priceEur: 49, pricePerCredit: '0,07€', highlight: true, badge: '⭐ Populaire' },
  { id: 'ai_topup_2000', name: 'Pack 2000', credits: 2000, priceEur: 99, pricePerCredit: '0,05€', highlight: false, badge: '💰 Meilleure valeur' },
];
...
export function CreditsTopUpModal({ open, onClose }: CreditsTopUpModalProps) {
  ...
  const [selectedPack, setSelectedPack] = useState<string>('ai_topup_750');
  ...
  const handleCheckout = async () => {
    ...
    const result = await createOneTimeCheckout(pack.id as 'ai_topup_250' | 'ai_topup_750' | 'ai_topup_2000', {
