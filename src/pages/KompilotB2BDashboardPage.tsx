    ...
    <div className="flex h-full w-[min(86vw,16rem)] flex-col border-r border-border bg-sidebar">
      ...
      <div className="flex-1 overflow-y-auto px-3 py-5">
        ...
        <div className="space-y-1">
          <Link to="/calendar" onClick={onClose} className="flex min-h-11 items-center gap-3 rounded-xl px-3 text-sm font-semibold text-foreground/70 hover:bg-muted hover:text-foreground"><CalendarDays size={17} /> Calendrier</Link>
