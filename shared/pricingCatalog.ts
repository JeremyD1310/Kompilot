...
export type PricingProductId =
  | 'pilot_30d_once'
  | 'ai_topup_250' | 'ai_topup_750' | 'ai_topup_2000'
...
export const ONE_TIME_PRODUCTS: readonly OneTimeProductDefinition[] = [
  ...
  { id: 'ai_topup_250', name: 'Recharge 250 crédits IA', amountEurHt: 19, productType: 'topup', creditType: 'ai', creditAmount: 250, creditEligible: true, lookupKey: 'kompilot_ai_250_once', description: 'Recharge IA valable 12 mois.', paymentRule: 'Paiement comptant, sans renouvellement' },
  { id: 'ai_topup_750', name: 'Recharge 750 crédits IA', amountEurHt: 49, productType: 'topup', creditType: 'ai', creditAmount: 750, creditEligible: true, lookupKey: 'kompilot_ai_750_once', description: 'Recharge IA valable 12 mois.', paymentRule: 'Paiement comptant, sans renouvellement' },
  { id: 'ai_topup_2000', name: 'Recharge 2 000 crédits IA', amountEurHt: 99, productType: 'topup', creditType: 'ai', creditAmount: 2000, creditEligible: true, lookupKey: 'kompilot_ai_2000_once', description: 'Recharge IA valable 12 mois.', paymentRule: 'Paiement comptant, sans renouvellement' },
